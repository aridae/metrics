...
### staticlint registered analyzers 
...
```
    ...
    errwrap      wrap errors in fmt.Errorf() calls with the %w verb directive
    ...
    nomainosexit direct call of os.Exit() in main() function of main package is not allowed
...
Run 'staticlint help' for more detail, or 'staticlint help name' for details and flags of a specific analyzer.
```
