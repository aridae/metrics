...
func (m *MockmetricsRepo) GetLatestState(ctx context.Context, metricKey models.MetricKey) (*models.ScalarMetric, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetLatestState", ctx, metricKey)
...
func (mr *MockmetricsRepoMockRecorder) GetLatestState(ctx, metricKey any) *gomock.Call {
	...
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetLatestState", reflect.TypeOf((*MockmetricsRepo)(nil).GetLatestState), ctx, metricKey)
}
